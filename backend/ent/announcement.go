...
type Announcement struct {
	...
	Priority announcement.Priority `json:"priority,omitempty"`
...
func (*Announcement) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case announcement.FieldPublished:
			values[i] = new(sql.NullBool)
		case announcement.FieldID, announcement.FieldCreatedBy:
			values[i] = new(sql.NullInt64)
		case announcement.FieldTitle, announcement.FieldContent, announcement.FieldPriority:
	...
	for i := range columns {
		...
		case announcement.FieldPriority:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				_m.Priority = announcement.Priority(value.String)
			}
		case announcement.FieldPublished:
