...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			attackreport.Table:         attackreport.ValidColumn,
			challenge.Table:            challenge.ValidColumn,
			challengehint.Table:        challengehint.ValidColumn,
			challengeinstance.Table:    challengeinstance.ValidColumn,
			challengetag.Table:         challengetag.ValidColumn,
			checkresult.Table:          checkresult.ValidColumn,
			competition.Table:          competition.ValidColumn,
			competitionchallenge.Table: competitionchallenge.ValidColumn,
			conversation.Table:         conversation.ValidColumn,
			cronjob.Table:              cronjob.ValidColumn,
			defensereport.Table:        defensereport.ValidColumn,
			dict.Table:                 dict.ValidColumn,
			errorlog.Table:             errorlog.ValidColumn,
			exercisephase.Table:        exercisephase.ValidColumn,
			file.Table:                 file.ValidColumn,
			flagsubmission.Table:       flagsubmission.ValidColumn,
			...
			scorerecord.Table:          scorerecord.ValidColumn,
			scoringround.Table:         scoringround.ValidColumn,
			setting.Table:              setting.ValidColumn,
			team.Table:                 team.ValidColumn,
			teammember.Table:           teammember.ValidColumn,
			teamregistration.Table:     teamregistration.ValidColumn,
			user.Table:                 user.ValidColumn,
			userpreference.Table:       userpreference.ValidColumn,
			webhook.Table:              webhook.ValidColumn,
			writeup.Table:              writeup.ValidColumn,
		})
	})
